...
const createWish = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const wishData = __rest(req.body, []);
    const result = yield wishList_service_1.wishListService.createWish(wishData);
...
const deleteWish = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield wishList_service_1.wishListService.deleteWish(_id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
